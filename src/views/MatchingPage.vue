...
const cards = ref<Card[]>([
    { id: 1, name: 'Limpeza Rio Jacuí', description: 'Limpar o rio vai fazer bem para todos, a população não aguenta mais estamos todos deseperados.', location: 'Caldas Rosas, SP', image: 'https://docs-demo.ionic.io/assets/madison.jpg' },
    { id: 2, name: 'Sopa solidária', description: 'Vamos fazer sopa para todos os moradores afetados', location: 'Caldas Rosas, SP', image: 'https://picsum.photos/400/600?random=2' },
    ...
    { id: 4, name: 'Formatar computadores', description: 'Precisamos de voluntários para formatar PCs de escolas locais.', location: 'Caldas Rosas, SP', image: 'https://picsum.photos/400/600?random=4' },
]);
